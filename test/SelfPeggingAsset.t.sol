...
contract SelfPeggingAssetTest is Test {
    ...
    function test_ExchangeRateFee_Scenario1() external {
        ...
        data = abi.encodeCall(
            SelfPeggingAsset.initialize,
            (_tokens2, _precisions, _fees, 0, _lpToken2, A, exchangeRateProviders2, address(0), 0.5e10)
        );
        ...
        // 20% rate change
        rETHExchangeRateProvider1.setExchangeRate(1.2e18);
        wstETHExchangeRateProvider1.setExchangeRate(1.2e18);

        rETHExchangeRateProvider2.setExchangeRate(1.2e18);
        wstETHExchangeRateProvider2.setExchangeRate(1.2e18);
        ...
        assertEq(rETHBalance1, 0);
        assertIsCloseTo(wstETHBalance1, 1e18, 0.006 ether);

        uint256 rETHBalance2 = rETH2.balanceOf(user2);
        uint256 wstETHBalance2 = wstETH2.balanceOf(user2);

        assertEq(rETHBalance2, 0);
