...
*Governance address for the stable swap token.*
...
*Initializes stable swap token contract.*
...
*Mints new stable swap token. Only minters can mint stable swap token.*

#### Parameters

| Name | Type | Description |
|---|---|---|
| _user | address | Recipient of the minted stable swap token. |
| _amount | uint256 | Amount of stable swap token to mint. |
...
```solidity
function setMinter(address _user, bool _allowed) external nonpayable
```



*Sets minter for stable swap token. Only minter can mint stable swap token.*

#### Parameters

| Name | Type | Description |
|---|---|---|
| _user | address | Address of the minter. |
| _allowed | bool | Whether the user is accepted as a minter or not. |
...
| Name | Type | Description |
|---|---|---|
| account `indexed` | address | Address of the new governance. |
